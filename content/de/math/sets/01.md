...
> **Beispiel:** $\\{x\\,|\\,x$ ist eine natürliche Zahl und $x\\lt8\\}$\
> Gesprochen: Die Menge aller $x$ für die gilt, dass $x$ eine natürliche Zahl
> ist und kleiner als $8$ ist.
> 
> **Weiteres Beispiel:**
> $\\{y\\,|\\,y$ ist ein Haustier und $y$ macht miau$\\}$\
> Gesprochen: Die Menge aller $y$ für die gilt, dass $y$ ein Haustier ist und miau macht.
> > Hier wäre ein Element der zweiten Menge:
> 
